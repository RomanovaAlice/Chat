...
final class UsersViewController: UIViewController {
    ...
    private let chat = [User(userImage: "", userName: ""), User(userImage: "1", userName: ""), User(userImage: "2", userName: ""), User(userImage: "3", userName: ""), User(userImage: "4", userName: ""), User(userImage: "5", userName: "")]
   ...
   private func setupDataSource() {
       dataSource = UICollectionViewDiffableDataSource<Section, User>(collectionView: usersCollectionView, cellProvider: { collectionView, indexPath, itemIdentifier in
